...
function Authlayout() {
  ...
  const adminRoutes = [
    ...
    { to: "/staffmangement", name: "Staff Management"},
    { to: "/equipmentmanagement", name: "Equipment Management"},
    { to: "/studentlist", name: "Student List"}
  ];
  const studentRoutes = [
    { to: "/requestequipment", name: "Request Equipment"},
    { to: "/currentreservations", name: "Current Reservations"},
  ];
  const staffRoutes = [
    { to: "/acceptequipment", name: "Accept Equipment"},
    { to: "/studentslist", name: "Students List"}
  ];
